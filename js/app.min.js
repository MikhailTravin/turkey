...
const swiperPartners = new Swiper('.partners__image', {
	slidesPerView: 6,
	spaceBetween: 30,
	autoHeight: false,
	speed: 800,
...
const swiperTeachers = new Swiper('.teachers__slider', {
	slidesPerView: 3,
	spaceBetween: 20,
	autoHeight: true,
	speed: 800,
...
let arrow_next = document.querySelector('.slider__nav-btn.slider__nav_next'),
	arrow_prev = document.querySelector('.slider__nav-btn.slider__nav_prev'),
	slider_tab = document.querySelectorAll('.slider__tab'),
	slides = document.querySelectorAll('.slider__slide'),
	slider_tabs_list = document.querySelector('.slider__tabs'),
	current_slide = 1;

arrow_next.addEventListener('click', (e) => {
	let sliders_count = slides.length
	if (current_slide < sliders_count) {
		current_slide += 1
		let tab_iteration = 1
		slider_tab.forEach((elem) => {
			let tab_num = parseInt(elem.getAttribute('data-slide-number'))
			if (current_slide == tab_num) {
				elem.classList.add('slider__nav-btn_active')
			}
			else {
				elem.classList.remove('slider__nav-btn_active')
			}
		})
		slides.forEach((elem) => {
			let slide_num = parseInt(elem.getAttribute('data-slide-number'))
...
arrow_prev.addEventListener('click', (e) => {
	let sliders_count = slides.length
	if (current_slide > 1) {
		current_slide -= 1
		let tab_iteration = 1
...
slider_tab.forEach((tab) => {
	tab.addEventListener('click', (e) => {
		let tab_num = tab.getAttribute('data-slide-number')

		slider_tab.forEach((elem) => {
			elem.classList.remove('slider__nav-btn_active')
		})
		slides.forEach((slide) => {
			let slide_num = slide.getAttribute('data-slide-number')
			if (slide_num === tab_num) {
		...
		current_slide = parseInt(tab_num)
		console.log(tab_num)
		console.log(current_slide)
		tab.classList.add('slider__nav-btn_active')
	})
